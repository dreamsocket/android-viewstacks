...
public class ViewTransition implements Parcelable
{
	...
	public ViewTransition(int p_in, int p_out)
	{
		this.in = p_in;
		this.out = p_out;
	}
    ...
    {
    	p_out.writeInt(this.in);
    	p_out.writeInt(this.out);
    }

    public static final Parcelable.Creator<ViewTransition> CREATOR = new Parcelable.Creator<ViewTransition>() 
    {
        public ViewTransition createFromParcel(Parcel p_in) 
        {
            return new ViewTransition(p_in);
        }

        public ViewTransition[] newArray(int p_size) 
        {
            return new ViewTransition[p_size];
        }
    };
    
    
    private ViewTransition(Parcel p_in) 
    {
        this.in = p_in.readInt();
        this.in = p_in.readInt();
    }	
}
